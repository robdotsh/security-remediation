# Security Remediation – 90 Day Program

This repository showcases a production-ready 90-day security remediation program
for a hybrid environment (on-prem + cloud).
